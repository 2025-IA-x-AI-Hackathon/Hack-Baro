...
# `apps/desktop/src/shared/detection/assets` 아래 mediapipe.zip 의 압축을 해당 디렉토리에 풉니다. 파일들이 `apps/desktop/src/shared/detection/assets/face_landmarker.task` 처럼. `apps/desktop/src/shared/detection/assets` 아래 있어야 합니다.
```
